...
public class SubtractingDailyLimitCoinsTest {
    ...
    @Test
    public void subtractingDailyLimitCoins() {
        ...
        ViewInteraction appCompatButton = onView(
                allOf(withId(R.id.transfer_button), withText("TRANSFER "),
                        childAtPosition(
        ...
        ViewInteraction textView = onView(
                allOf(withText("24"),
                        isDisplayed()));
        textView.check(matches(withText("24")));
