...
public class CannotSendCoinsToYourselfTest {
    ...
    @Test
    public void cannotSendCoinsToYourselfTest() {
        ...
        ViewInteraction imageView2 = onView(
                allOf(withId(R.id.send_coins_button), withContentDescription("send_coins_button"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
